...
const generateRandomQuote = async () => {
  const randomQuote = await fetch(
    ...
    {
      method: "GET",
      url: "https://api.api-ninjas.com/v1/quotes?category=business",
      headers: { "X-Api-Key": "U6qNWEiNpz2VIhl1LQbI8A==PU9kt7ypB548E4TB" },
...
const paragraphAndInputFunctionality = () => {
  ...
  */
  ...
  function getLastWordIneachLine() {
    ...
    // This will make the height of the textElement consist one line
...
const statsFunctionality = () => {
  ...
  const wpmInterval = setInterval(calculateWpm, 500);
};
